...
const coolInStr = motto.indexOf("cool");
console.log(coolInStr > 0);
...
let result = motto.replace("iSchool", "Information School");
console.log(result);
...
console.log(((result.length / mottoLength) * 100).toFixed(2) + "%");
